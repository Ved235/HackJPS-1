...
Swal.fire({
    title: "Final level",
    text: "Find the equivalent resistance of the two resistors connected in parallel.",
...
rangeInput.addEventListener("input",function(){
  ...
  if(i == 10){
    current.style = " transform: rotate(56deg) ;";
    voltage.style = " transform: rotate(70.5deg) ;";
  }
  if(i == 20){
    current.style = " transform: rotate(83deg) ;";
    voltage.style = " transform: rotate(110deg) ;"; 
  }
  if(i == 30){
    current.style = " transform: rotate(107deg) ;";
